...
begin//DoCross
 ...
 theCross.Y := (Self.dX * anOther.dY * Self.A.Y - (anOther.B.X - anOther.A.X) * (Self.B.Y - Self.A.Y) * anOther.A.Y + (anOther.A.X - Self.A.X) * (Self.B.Y - Self.A.Y) * (anOther.B.Y - anOther.A.Y)) /
               (Self.dX * anOther.dY - (anOther.B.X - anOther.A.X) * (Self.B.Y - Self.A.Y));
