...
Родители элемента ::TkwCompiledMain::CodeGen
 ...
 Родители элемента ::TkwCompiledMain::CodeGen::Project1
 ; // Library1
 ...
 Родители элемента ::TkwCompiledMain::CodeGen::Project1
  ...
  Родители элемента ::TkwCompiledMain::CodeGen::Project1::Program1
  ; // Class1
  cpp : OPERATOR StereotypeStereotypeProducer <<@meta>> <<UMLClass>> <<Class>> Class2
  Родители элемента ::TkwCompiledMain::CodeGen::Project1::Program1
   cpp : OPERATOR NamedWordProducer %INHERITS %G
   Родители элемента ::TkwCompiledMain::CodeGen::Project1::Program1::Class2
   ; // %G
  ...
  Родители элемента ::TkwCompiledMain::CodeGen::Project1::Program1
   cpp : OPERATOR NamedWordProducer %INHERITS %G
   Родители элемента ::TkwCompiledMain::CodeGen::Project1::Program1::Class4
   ; // %G
  ; // Class4
