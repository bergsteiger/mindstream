...
// ћодуль: "kwCompiledInitedVarProducer.pas"
// –одные Delphi интерфейсы (.pas)
// Generated from UML model, root element: SimpleClass::Class Shared Delphi Low Level::ScriptEngine::VarProducing::TkwCompiledInitedVarProducer
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//#UC START# *4F219629036A_4F3D32ED0065_impl*
 CompilerAssert((aCompiled.CodeCount = 1),
                'Ќе найдено значение переменной',
                aContext);
 ...
 CompilerAssert(l_VC1 >= l_VC,
                Format('—лово %s дл€ инициализации переменной %s понизило уровень стека',
                       [
                        l_C.Key.AsString,
 ...
 CompilerAssert(l_VC1 <= l_VC + 1,
                Format('—лово %s дл€ инициализации переменной %s повысило уровень стека более чем на одно значение',
                       [
                        l_C.Key.AsString,
                        aCompiled.Key.AsString
                       ]),
 ...
 begin
  ...
  try
   ...
   // - тут создаЄм автоматическую ссылку
   begin
  ...
  CompilerAssert(CanBeVoid, 'ѕеременна€ не может быть инициализирована пустым значением', aContext);
...
initialization
{$If not defined(NoScripts)}
// –егистраци€ TkwCompiledInitedVarProducer
 TkwCompiledInitedVarProducer.RegisterInEngine;
{$IfEnd} //not NoScripts
