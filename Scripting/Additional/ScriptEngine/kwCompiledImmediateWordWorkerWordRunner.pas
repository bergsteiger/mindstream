...
// Модуль: "kwCompiledImmediateWordWorkerWordRunner.pas"
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: SimpleClass::Class Shared Delphi Low Level::ScriptEngine::Scripting Axiomatics::TkwCompiledImmediateWordWorkerWordRunner
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
initialization
{$If not defined(NoScripts)}
// Регистрация TkwCompiledImmediateWordWorkerWordRunner
 TkwCompiledImmediateWordWorkerWordRunner.RegisterClass;
{$IfEnd} //not NoScripts
