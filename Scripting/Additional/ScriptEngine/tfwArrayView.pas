...
// Модуль: "w:/common/components/rtl/Garant/ScriptEngine/tfwArrayView.pas"
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: <<SimpleClass::Class>> Shared Delphi Scripting::ScriptEngine::ArrayProcessing::TtfwArrayView
//
//
