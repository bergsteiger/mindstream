...
// Модуль: "kwImmedCompiledStereotypedStereotypedWord.pas"
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: SimpleClass::Class Shared Delphi Low Level::ScriptEngine::Stereotyping::TkwImmedCompiledStereotypedStereotypedWord
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
initialization
{$If not defined(NoScripts)}
// Регистрация TkwImmedCompiledStereotypedStereotypedWord
 TkwImmedCompiledStereotypedStereotypedWord.RegisterClass;
{$IfEnd} //not NoScripts
