...
// Generated from UML model, root element: <<Impurity::Class>> Shared Delphi Scripting::ScriptEngine::Scripting Axiomatics::tfwCompilingWord
//
//
...
procedure _tfwCompilingWord_.AfterCompile(const aPrevContext: TtfwContext;
  var theNewContext: TtfwContext;
...
function _tfwCompilingWord_.AfterWordMaxCount(const aCtx: TtfwContext): Cardinal;
...
function _tfwCompilingWord_.CompiledWordClass(const aCtx: TtfwContext): RkwCompiledWordPrim;
...
function _tfwCompilingWord_.DisabledEndBracket(const aContext: TtfwContext;
  aSilent: Boolean): RtfwWord;
...
procedure _tfwCompilingWord_.FillCompiledWord(aCompiled: TtfwWord;
...
function _tfwCompilingWord_.SupressNextImmediate: TtfwSuppressNextImmediate;
...
procedure _tfwCompilingWord_.DoKeyword(var aContext: TtfwContext;
  aWord: TtfwWord;
  const aFinder: Il3KeywordFinder;
...
end;//_tfwCompilingWord_.DoKeyword
...
function _tfwCompilingWord_.CompiledWordClassPrim(const aCtx: TtfwContext): RtfwWord;
...
function _tfwCompilingWord_.GetEndBracket(const aContext: TtfwContext;
  aSilent: Boolean): RtfwWord;
...
end;//_tfwCompilingWord_.GetEndBracket
