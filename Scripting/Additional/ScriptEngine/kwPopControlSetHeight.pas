...
// Модуль: "w:/common/components/rtl/Garant/ScriptEngine/kwPopControlSetHeight.pas"
...
//#UC START# *4F212C3A015A_4F7C57CD01E3_impl*
 RunnerAssert(aCtx.rEngine.IsTopInt, 'Не задано значение высоты контрола!', aCtx);
