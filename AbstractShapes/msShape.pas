...
type
 ...
 protected
  ...
  procedure MouseMove(const aDiagramm: ImsDiagramm; const aPoint: TPointF); virtual;
...
procedure TmsShape.MouseMove(const aDiagramm: ImsDiagramm; const aPoint: TPointF);
begin
