 ...
 TraverseTree(tvTestTree,
  ...
  begin
   ...
   begin
    ...
    try
     l_EtalonsHolder.IsUseDiffer := chkIsUseDiffer.IsChecked;
...
begin
 FSuite.SaveConfiguration(ParamStr(0) + c_ConfigFile, false, true);
 Suite := nil;
 inherited;
end;
...
begin
 ...
 begin
  ...
  // Костыль !! { TODO -oIngword -cСовершенный код : Разобраться }
  //tvTestTree.ItemByIndex(0).IsChecked := True;
 end; // FSuite <> nil
end;
