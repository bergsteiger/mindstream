...
initialization
{!touched!}{$IfDef LogInit} WriteLn('m0\pas\m0lzolib.pas initialization enter'); {$EndIf}
...
{$EndIF  _m0USEEXTGETMEM1}
  _Initialization;
{$IfDef m0MultiThreadLZO}
{!touched!}{$IfDef LogInit} WriteLn('m0\pas\m0lzolib.pas initialization leave'); {$EndIf}
(*finalization
  _Finalization;*)
{$EndIf m0MultiThreadLZO}
