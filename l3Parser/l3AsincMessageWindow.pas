...
initialization
{!touched!}{$IfDef LogInit} WriteLn('l3AsincMessageWindow.pas initialization enter'); {$EndIf}
 g_AllAsyncWindows := TThreadList.Create;
 l3System.AddExitProc(FinalizeAllAsyncWindows);

{!touched!}{$IfDef LogInit} WriteLn('l3AsincMessageWindow.pas initialization leave'); {$EndIf}
end.
