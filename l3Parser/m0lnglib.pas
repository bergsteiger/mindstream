...
initialization
{!touched!}{$IfDef LogInit} WriteLn('m0\pas\m0lnglib.pas initialization enter'); {$EndIf}

{!touched!}{$IfDef LogInit} WriteLn('m0\pas\m0lnglib.pas initialization leave'); {$EndIf}
finalization
