...
function TtfwVarWorker.AfterWordMaxCount(const aCtx: TtfwContext): Integer;
...
//#UC START# *4DB9BBD6024F_4DCBD36B01C4_impl*
 ...
 l_VarWorker := CompiledVarWorkerClass.Create((aWord As TkwCompiledWordPrim).GetCode(aContext)[0], Self, aContext);
 try
