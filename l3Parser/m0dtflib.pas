...
initialization
{!touched!}{$IfDef LogInit} WriteLn('m0\pas\m0dtflib.pas initialization enter'); {$EndIf}
  _Initialization();

{!touched!}{$IfDef LogInit} WriteLn('m0\pas\m0dtflib.pas initialization leave'); {$EndIf}
finalization
  _Finalization();
