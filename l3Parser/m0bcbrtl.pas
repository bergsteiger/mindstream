...
initialization
{!touched!}{$IfDef LogInit} WriteLn('m0\pas\m0bcbrtl.pas initialization enter'); {$EndIf}
 g_Buffers12 := l3NewMemoryChain(12);
 g_Buffers20 := l3NewMemoryChain(20);

{!touched!}{$IfDef LogInit} WriteLn('m0\pas\m0bcbrtl.pas initialization leave'); {$EndIf}
end.
